        ...
        <div className="bg-gray-100">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm font-semibold uppercase text-gray-500 tracking-wide">
              Protocols & Sponsors used in this projects
            </p>
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                      For Teams, Businesses and Organisations. Get the pro plan
                      for unlimited video streams and organization tools.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
              ...
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                      Felix Prabitz, Dominic Hackett and Devin Lamoreux.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
        ...
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2022 DAZOOM, HACK FS - ETH Global
            </p>
          </div>
        </div>
      </footer>
