            ...
            <div className="p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 w-0 flex-1">
                  <p className="text-sm font-medium text-gray-900">{(props.data.get("team") ? props.data.get("team"): props.data.get("from"))}</p>
                  <p className="mt-1 text-sm text-gray-600">{props.data.get("meetingName")}</p>
                  <p className="mt-1 text-sm text-gray-500">{props.data.get("meetingDate")}</p>
